...
export default function Error() {
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center px-6 bg-slate-50 dark:bg-slate-900">
        <motion.div
        ...
        >
          {/* Big 404 */}
          <h1 className="text-[6rem] md:text-[7rem] font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-green-500">
            404
          </h1>
