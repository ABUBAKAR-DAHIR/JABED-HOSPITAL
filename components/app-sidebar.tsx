...
const navItems = [
  ...
  { id: "patient-info", title: "Patient Info", icon: BookOpen },
  { id: "appointments", title: "Appointments", icon: Settings2 },
  { id: "health-notifications", title: "Health Notifications", icon: Bell },
]
...
export function AppSidebar({ active, user, setActive }: AppSidebarProps) {
  ...
  return (
    <Sidebar collapsible="icon">
      <SidebarHeader>
        <TeamSwitcher teams={[{ name: "Home", logo: House, plan: "Patient" }, { name: "Patient", logo: BookOpen, plan: "Premium" }]} />
      </SidebarHeader>
